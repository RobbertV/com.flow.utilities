exports.init = async function (homey) {
    ...
    action_START_DATE.registerRunListener(async (args) => {
        ...
        await homey.app.action_START_DATE(args.name);
    });
    ...
    action_END_DATE.registerRunListener(async (args) => {
        ...
        await homey.app.action_END_DATE(args.name);
    });

    const action_START_DATE_COMPARE = homey.flow.getActionCard('action_START_DATE_COMPARE');
    ...
    const action_END_DATE_COMPARE = homey.flow.getActionCard('action_END_DATE_COMPARE');
