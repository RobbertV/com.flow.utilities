...
exports.zoneAutoComplete = async function (ctx, query) {
    ...
    zones = zones.sort((a, b) => (a.order > b.order ? 1 : -1));
...
exports.calculateDuration = function (startDate, endDate, i18n, log) {
    ...
    return `${this.singleOrPluralTime(i18n, days, 'day')}${this.singleOrPluralTime(i18n, hours, 'hour')}${this.singleOrPluralTime(i18n, minutes, 'minute')}`;
};
